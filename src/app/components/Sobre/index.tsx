...
export const AboutMe = () => {
  return (
    <Grid id="sobre" container justifyContent="center" sx={{flexDirection: { xs: "block", md: "row" }, gap: { xs:"10px", md: "30px" }, padding: { xs: "40px", ms: "40px" }, height:{xs:"90%", md:"100%"}}}  >
      <Grid item sx={{ height: { xs: "250px", md: "100%" }, width: { xs: "100%", md: "40%" }, paddingTop:{md:"170px"}}} textAlign="left" >
