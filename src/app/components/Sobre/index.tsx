  ...
  return (
    <Grid id="sobre" container justifyContent="center" sx={{flexDirection: { xs: "block", md: "row" }, gap: { xs:"10px", md: "30px" }, padding: { xs: "40px", ms: "40px" }, height:{xs:"90%", md:"100%"}, background:"#6A0C0B"}} >
      <Grid item sx={{ height: { xs: "250px", md: "100%" }, width: { xs: "100%", md: "40%" }, paddingTop:{md:"170px"}}} textAlign="left" >
        ...
        <Typography color="#FBCA03" variant='subtitle1' sx={{paddingTop:{xs:"10px", md:"55px"}}}>Sou alguém que ama aventuras ao ar livre. Adoro fazer trilhas, jogar futebol e também sou um entusiasta do ciclismo. Estou sempre em busca de desafios e novas experiências, seja na tecnologia ou explorando a natureza.</Typography>
        <Grid>
